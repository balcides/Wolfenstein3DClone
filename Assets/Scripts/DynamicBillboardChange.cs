...
public class DynamicBillboardChange : MonoBehaviour {
	...
	[SerializeField] string[] animStates = new string[4]{ "Forward", "Backward", "Left", "Right" };
	...
	void GetAngle(){
		...
		//if enemy is forward or backward
		...
		//else if enemy is left or right (or not forward or backward)
		} else {
