...
public class Rocket : MonoBehaviour {
	...
	private void OnCollisionEnter(Collision collision){
		...
		GameObject  explosionInstiated = (GameObject) Instantiate (explosion, contact.point, Quaternion.identity);
		explosionInstiated.GetComponent<Explosion> ().explosionSound = explosionSound;
